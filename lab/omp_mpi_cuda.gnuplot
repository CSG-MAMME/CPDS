...
plot './omp/omp-par/omp_data.dat' using 1:2 w linespoints ls 01 title 'Jacobi' axis x1y1, \
     './omp/omp-par/omp_data.dat' using 1:3 w linespoints ls 11 notitle '' axis x1y2, \
     './omp/omp-par/omp_data.dat' using 1:4 w linespoints ls 02 title 'Red Black' axis x1y1, \
     './omp/omp-par/omp_data.dat' using 1:5 w linespoints ls 12 notitle '' axis x1y2, \
     './omp/omp-par/omp_data.dat' using 1:6 w linespoints ls 03 title 'Gauss Seidel' axis x1y1, \
     './omp/omp-par/omp_data.dat' using 1:7 w linespoints ls 13 notitle '' axis x1y2
...
set yrange [0:4]
set y2range [0:4]
plot './mpi/mpi-par/mpi_data.dat' using 1:2 w linespoints ls 01 title 'Jacobi' axis x1y1, \
     './mpi/mpi-par/mpi_data.dat' using 1:3 w linespoints ls 11 notitle '' axis x1y2, \
